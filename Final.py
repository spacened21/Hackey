...
def admin():
    ...
    if intpass == password:
        ...
        while True:
            print("1-Add a New Employee \n2-Display all Employee \n3-Search an Employee \n4-Update Employee Details(Upcoming Feature)"
                  "\n5-Fire an Employee(Upcoming Feature) \n6-Display Feedback's(Upcoming Feature)")
            ...
            if userinput == 1:                    
                    while True:
                        with open ("employee.dat", 'ab+') as f:
                            ...
                            lis=[no, name, net , work]
                            pickle.dump(lis, f)
                            c = input("Would you like to add more(y/n): ")
                            if c.lower() == 'n':
                                break
            elif userinput == 2:
                with open("employee.dat", "rb") as f:
                    try:
                        ...
                        while True:
                            read=pickle.load (f)
                            print (str (read[0]).center (20), str (read[1]). center (20), str (read[2]).center (20),str(read[3]).center(20))
                            print ("="*80)
                    except EOFError:
                        pass
            elif userinput == 3:
